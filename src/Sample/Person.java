...
/**
 * Cache' Java Class Generated for class Sample.Person on version Cache for Windows (x86-64) 2018.1.5 (Build 659U) Mon Mar 22 2021 07:03:57 EDT.<br>
 ...
 *
 * @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person</A>
**/

public class Person extends com.intersys.classes.Persistent {
    private static final long serialVersionUID = 5948;
...
This is a calculated field whose value is derived from <property>DOB</property>.</p>
       ...
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Age"> Age</A>
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#DOB"> DOB</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColors"> FavoriteColors</A>
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Home"> Home</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Name"> Name</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Office"> Office</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSN"> SSN</A>
    */
    ...
    */
    ...
    /**
       ...
       @throws com.intersys.objects.CacheException if any error occurred during value retrieval.
       @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Spouse"> Spouse</A>
    */
...
with the pre-package behaviour of %ClassName.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%ClassName"> Method %ClassName</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%ComposeOid"> Method %ComposeOid</A>
    */
...
transaction is committed, otherwise it is rolled back. </p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%Delete"> Method %Delete</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%DeleteExtent"> Method %DeleteExtent</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%DeleteId"> Method %DeleteId</A>
    */
...
on the optional <var>concurrency</var> argument.</p>
    ...
    */
	...
	Check to see if an OID exists in the extent of this class...</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%Exists"> Method %Exists</A>
    */
    ...
    */
	...
	Check to see if an ID exists in the extent of this class...</p>
     ...
     @param id represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%ExistsId"> Method %ExistsId</A>
    */
...
That is 'isclass' is a primary superclass of this object.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%IsA"> Method %IsA</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%KillExtent"> Method %KillExtent</A>
    */
...
extent physical data. Also this will not remove stream data associated with these instances.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%LockId"> Method %LockId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%ObjectIsNull"> Method %ObjectIsNull</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%SaveIndices"> Method %SaveIndices</A>
    */
...
<p>Returns a <CLASS>%Status</CLASS> value indicating success or failure.</p>
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#%UnlockId"> Method %UnlockId</A>
    */
...
and return the result.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Addition"> Method Addition</A>
    */
...
and return the result.</p>
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#AgeDisplayToLogical"> Method AgeDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#AgeIsValid"> Method AgeIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#AgeLogicalToDisplay"> Method AgeLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#CurrentAge"> Method CurrentAge</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#DOBDisplayToLogical"> Method DOBDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#DOBIsValid"> Method DOBIsValid</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#DOBLogicalToDisplay"> Method DOBLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsDisplayToLogical"> Method FavoriteColorsDisplayToLogical</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsGetObject"> Method FavoriteColorsGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsGetObjectId"> Method FavoriteColorsGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsIsValid"> Method FavoriteColorsIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsLogicalToDisplay"> Method FavoriteColorsLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsSetObject"> Method FavoriteColorsSetObject</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#FavoriteColorsSetObjectId"> Method FavoriteColorsSetObjectId</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#HomeGetObject"> Method HomeGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#HomeGetObjectId"> Method HomeGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#HomeIsValid"> Method HomeIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#HomeSetObject"> Method HomeSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#HomeSetObjectId"> Method HomeSetObjectId</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#IDKEYDelete"> Method IDKEYDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#IDKEYExists"> Method IDKEYExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#IDKEYOpen"> Method IDKEYOpen</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#NameDisplayToLogical"> Method NameDisplayToLogical</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#NameIDXExists"> Method NameIDXExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#NameIsValid"> Method NameIsValid</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#NameLogicalToDisplay"> Method NameLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#NinetyNine"> Method NinetyNine</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#OfficeGetObject"> Method OfficeGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#OfficeGetObjectId"> Method OfficeGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#OfficeIsValid"> Method OfficeIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#OfficeSetObject"> Method OfficeSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#OfficeSetObjectId"> Method OfficeSetObjectId</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Populate"> Method Populate</A>
    */
...
<LINK href=DocBook.UI.Page.cls?KEY=GOBJ_populate>The Cach&eacute; Populate Utility</LINK>.</p>
    ...
    */
    ...
    /**
     ...
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#PopulateSerial"> Method PopulateSerial</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#PrintPerson"> Method PrintPerson</A>
    */
...
within the database.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#PrintPersons"> Method PrintPersons</A>
    */
...
iterate over all the person data.</p>
     @param db represented as com.intersys.objects.Database
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#PrintPersonsSQL"> Method PrintPersonsSQL</A>
    */
    ...
    /**
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#Random"> Method Random</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNDisplayToLogical"> Method SSNDisplayToLogical</A>
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNIsValid"> Method SSNIsValid</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNKeyDelete"> Method SSNKeyDelete</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNKeyExists"> Method SSNKeyExists</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNKeyOpen"> Method SSNKeyOpen</A>
    */
    ...
    */
    ...
    /**
     ...
     @param _val represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SSNLogicalToDisplay"> Method SSNLogicalToDisplay</A>
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SpouseGetObject"> Method SpouseGetObject</A>
    */
    ...
    */
    ...
    /**
     ...
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SpouseGetObjectId"> Method SpouseGetObjectId</A>
    */
    ...
    */
    ...
    /**
     ...
     @param value represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SpouseIsValid"> Method SpouseIsValid</A>
    */
    ...
    /**
     ...
     @param newvalue represented as com.intersys.objects.Oid
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SpouseSetObject"> Method SpouseSetObject</A>
    */
    ...
    /**
     ...
     @param newid represented as java.lang.String
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#SpouseSetObjectId"> Method SpouseSetObjectId</A>
    */
...
In this case this method returns the concatenation of a string value.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#StoredProcTest"> Method StoredProcTest</A>
    */
...
<var>Home.Zip</var> is equal to <var>zip</var>.</p>
     ...
     @throws com.intersys.objects.CacheException if any error occured while running the method.
     @see <a href = "http://MACBETH:57772/csp/documatic/%25CSP.Documatic.cls?APP=1&PAGE=CLASS&LIBRARY=SAMPLES&CLASSNAME=Sample.Person#UpdateProcTest"> Method UpdateProcTest</A>
    */
